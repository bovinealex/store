...
var Z=u.createElement("div");Z.style.cssText="position:fixed; z-index: 2147483647; width: "+W+"px; border-radius: 5px; background: white; 
  -family: serif; font-size: 14px; -webkit-box-shadow: 0 0 50px rgba(0,0,0,0.3); -moz-box-shadow:  0 0 50px rgba(0,0,0,0.3); box-shadow: 0 0 50px rgba(0,0,0,0.3);";
